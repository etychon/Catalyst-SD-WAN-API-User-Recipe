...
**UX 2.0 CSV onboard:** operator recipe [config-group-csv-onboard-deploy.md](../docs/recipes/config-group-csv-onboard-deploy.md); script `scripts/config_group_onboard.py` (module and function docstrings); library `src/sdwan_recipes/config_group.py`, `device_actions.py`.
