...
- **Hosted Edge Services (IOx / app hosting):** `POST /statistics/apphosting/page`, `GET /statistics/apphosting/doccount`, optional `POST /statistics/apphostinginterface/page` — recipe [hosted-edge-services-iox.md](../recipes/hosted-edge-services-iox.md); related `GET /sdavc/customapps` ([Get Custom App](https://developer.cisco.com/docs/sdwan/get-custom-app/))
