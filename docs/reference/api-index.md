...
- **UX 2.0 configuration groups:** [Get Config Group By Solution](https://developer.cisco.com/docs/sdwan/get-config-group-by-solution/), [Get Config Group Association](https://developer.cisco.com/docs/sdwan/get-config-group-association/), [Create Config Group Association](https://developer.cisco.com/docs/sdwan/create-config-group-association/), [Get Config Group Device Variables](https://developer.cisco.com/docs/sdwan/get-config-group-device-variables/), [Create Config Group Device Variables](https://developer.cisco.com/docs/sdwan/create-config-group-device-variables/), [Deploy Config Group](https://developer.cisco.com/docs/sdwan/deploy-config-group/) — recipes [config-group-ux2-sync-deploy.md](../recipes/config-group-ux2-sync-deploy.md), [config-group-csv-onboard-deploy.md](../recipes/config-group-csv-onboard-deploy.md)
- **Hosted Edge Services (IOx / app hosting):** `POST /statistics/apphosting/page`, `POST /statistics/apphosting/doccount` (filtered; sample default), optional `GET /statistics/apphosting/doccount` (unfiltered), optional `POST /statistics/apphostinginterface/page` — recipe [hosted-edge-services-iox.md](../recipes/hosted-edge-services-iox.md); related `GET /sdavc/customapps` ([Get Custom App](https://developer.cisco.com/docs/sdwan/get-custom-app/))
- **Device action task status:** `GET /dataservice/device/action/status/{processId}` — deploy poll in [config-group-csv-onboard-deploy.md](../recipes/config-group-csv-onboard-deploy.md); see also [Device Template](https://developer.cisco.com/docs/sdwan/device-template/)
